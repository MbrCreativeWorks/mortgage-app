...
const HeroArea = () => {
  return (
    <div className="heroArea bg-white h-[80vh]" id="home">
        ...
        <div className="container mx-auto py-20 flex flex-col lg:flex-row items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="mt-10 flex justify-center lg:justify-start ">
              <button className="radialColorBg text-black font-semibold px-6 py-3 rounded-lg mr-4 hover:bg-blue-600 transition">
                Apply Now
              </button>
              <button className="bg-gray-200 text-black font-semibold px-6 py-3 rounded-lg hover:bg-gray-300 transition">
                Learn More
              </button>
            </div>
          </div>
